...
export default async function handler(req, res) {
    ...
    console.log("c");
    console.log("currentUser", tokenData.username);
    console.log("tokenData.username", tokenData.username);
    const interaction = await interactionsCollection.findOne(
        {
            "userInteracting": req.body.params.userNoNoti,
            "userInteractedWith": tokenData.username,
        }
    );
