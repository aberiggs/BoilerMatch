...
export default function UpdatePassword({route, navigation}){
    ...
    const usernameVal = route.params.username

    const updatePasswordThroughApi = async () => {
        const response = await axios.post(process.env.EXPO_PUBLIC_API_HOSTNAME + '/api/user/updatepassword', {
    ...
    const handleUpdate = async () => {
        if (validatePassword() && passwordMatch()) {
            const res = await updatePasswordThroughApi()
